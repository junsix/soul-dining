      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-4 pt-4">
            ...
            <a href="#" className="hover:text-stone-100 transition-colors"><Mail size={20} /></a>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span>123 Culinary Road, Gangnam-gu,<br/>Seoul, South Korea</span>
            </li>
            ...
            <li className="flex items-center gap-3">
              ...
              <span>reservation@souldining.kr</span>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="pt-4 border-t border-stone-800">
            <p className="text-xs text-stone-500">Closed on Mondays & Tuesdays</p>
          </div>
        </div>
      </div>
