...
const CollaborationSection: React.FC = () => {
  ...
  return (
    <section id="collaboration" className="py-16 md:py-24 bg-stone-50">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-10 md:mt-16">
          {placeholders.map((_, index) => (
            ...
            >
              <span className="text-stone-400 text-xs md:text-sm tracking-widest uppercase">
                Brand Logo
              </span>
            </div>
          ))}
        ...
        <p className="text-center text-stone-500 mt-8 md:mt-12 text-sm font-light">
          소울 다이닝과 함께하는 브랜드들
        </p>
      </div>
    </section>
